...
create_library_set -name lib_min\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/SRAM_256X16_BC.lib]\
   -si\
...
create_library_set -name lib_max\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/SRAM_256X16_WC.lib]\
   -si\
...
create_constraint_mode -name func_mode\
   -sdc_files\
    [list /dev/null]
create_analysis_view -name av_func_mode_max -constraint_mode func_mode -delay_corner Delay_Corner_max -latency_file /RAID2/COURSE/2025_Spring/iclab/iclab087/Final_Project_2025/05_APR/CHIP_nanoRoute.inn.dat/libs/mmmc/latency.sdc
create_analysis_view -name av_func_mode_min -constraint_mode func_mode -delay_corner Delay_Corner_min -latency_file /RAID2/COURSE/2025_Spring/iclab/iclab087/Final_Project_2025/05_APR/CHIP_nanoRoute.inn.dat/libs/mmmc/latency.sdc
